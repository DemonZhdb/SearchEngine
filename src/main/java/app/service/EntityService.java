...
//    private JdbcTemplate jdbcTemplate;
    ...
    public void addEntities(Document doc, String url, int code, Site site, int pageId) throws SQLException, IOException {
        ...
        if (code == 200) {
            ...
            HashMap<Integer, Float> mapId = lemmaAdd(pageLemmaMap, site );
            indexAdd(page, mapId, site);
        }
    ...
    @Transactional
    public synchronized  HashMap<Integer, Float> lemmaAdd(Map<String, Float> lemmaMap,Site site) {
    ...
    @Transactional
    public synchronized  void indexAdd(Page page, HashMap<Integer, Float> idMap, Site site)  {
